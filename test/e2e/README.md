...
1. A running Kubernetes cluster (v1.23+)
...
- **Solution**: Manually delete the test namespace: `kubectl delete ns csi-addons-e2e`

**Issue**: CSI driver not found

- **Solution**: Ensure CSI driver with CSI-Addons sidecar is deployed and specify `CSI_DRIVER_NAME`
